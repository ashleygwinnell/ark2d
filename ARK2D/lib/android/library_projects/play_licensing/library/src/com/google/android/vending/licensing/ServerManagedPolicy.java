...
public class ServerManagedPolicy implements Policy {
    ...
    private static final long MILLIS_PER_TENYEARS = (10 * 364 * 24 * 60 * 60 * 1000);
    ...
    public void processServerResponse(int response, ResponseData rawData) {
        ...
        if (response == Policy.LICENSED) {
            ...
            Log.i("licensing", "time now: " + System.currentTimeMillis());
            Log.i("licensing", "valid until: " + extras.get("VT"));
    ...
    private void setValidityTimestamp(String validityTimestamp) {
        ...
        try {
            ...
            // EDIT   
            long years = 10L * 364L * 24L * 60L * 60L * 1000L;
            Log.i("licensing", "now: " + System.currentTimeMillis());
            Log.i("licensing", "ten years: " + years);
            
            long expiresOn = System.currentTimeMillis() + years;
            Log.i("licensing", "in ten years: " + expiresOn); 
            
            lValidityTimestamp = Long.valueOf(expiresOn); 
            validityTimestamp = Long.toString(lValidityTimestamp); 
            
            Log.i("licensing", "valid until try: " + validityTimestamp); 
            ...
            Log.i("licensing", "valid until catch: " + validityTimestamp);
        }
