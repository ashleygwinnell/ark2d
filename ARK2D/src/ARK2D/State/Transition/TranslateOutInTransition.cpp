...
void TranslateOutInTransition::preRender(GameContainer* container, StateBasedGame* game, Graphics* g) {

}

void TranslateOutInTransition::postRender(GameContainer* container, StateBasedGame* game, Graphics* g) {
