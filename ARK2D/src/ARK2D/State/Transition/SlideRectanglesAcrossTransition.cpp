...
namespace ARK {
	namespace State {
		namespace Transition {
			...
			void SlideRectanglesAcrossTransition::preRender(GameContainer* container, StateBasedGame* game, Renderer* g) {

			}

			void SlideRectanglesAcrossTransition::postRender(GameContainer* container, StateBasedGame* game, Renderer* g) {
