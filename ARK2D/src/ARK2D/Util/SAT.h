...
// http://www.sevenson.com.au/actionscript/sat/
	...
	class ARK2D_API CollisionInfo {
		...
		public:
			bool intersects;
			ARK::Geometry::Polygon<int>* one;
			ARK::Geometry::Polygon<int>* two;
			float distance;
			SATVector vector;
	...
	class ARK2D_API SAT {
		public:
			static CollisionInfo intersects(ARK::Geometry::Polygon<int>* one, ARK::Geometry::Polygon<int>* two);
			...
			static vector<SATVector> getVectors(ARK::Geometry::Polygon<int>* p);
			static void getVectors(ARK::Geometry::Polygon<int>* p, vector<SATVector>* resultVectors);
