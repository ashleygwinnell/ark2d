...
CollisionInfo SAT::intersects(ARK::Geometry::Polygon<int>* one, ARK::Geometry::Polygon<int>* two) {
...
vector<SATVector> SAT::getVectors(ARK::Geometry::Polygon<int>* p) {
...
void SAT::getVectors(ARK::Geometry::Polygon<int>* p, vector<SATVector>* resultVectors) {
