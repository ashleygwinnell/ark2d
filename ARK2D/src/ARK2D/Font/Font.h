...
namespace ARK {
	class Font {
		public:
			...
			virtual void drawStringCentered(const string& Str, int left_x, int right_x, int y) const = 0;
			virtual void drawStringCenteredAt(const string& Str, int x, int y) const = 0;
