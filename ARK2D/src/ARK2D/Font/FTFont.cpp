...
#if !defined(ARK2D_WINDOWS_PHONE_8) && !defined(ARK2D_WINDOWS) && !defined(ARK2D_UBUNTU_LINUX) && !defined(ARK2D_EMSCRIPTEN_JS) && !defined(ARK2D_ANDROID)
	...
	namespace ARK {
		namespace Font {
			...
			void FTFontData::make_dlist(FT_Face face, unsigned char ch, GLuint list_base, GLuint* tex_base) {
				...
				glTexImage2D(GL_TEXTURE_2D, 0, GL_RGBA, width, height, 0, GL_RGBA, GL_UNSIGNED_BYTE, expanded_data);
