            ...
            */
            ...
            class ARK2D_API Renderer
            {
                ...
                public:
                    ...
                    void setFont(ARK::Core::Font::Font* f);
                    void setDefaultFont(ARK::Core::Font::Font* f);
                    ARK::Core::Font::Font* getFont() const ;
                    ARK::Core::Font::Font* getDefaultFont() const;
                ...
                public:
                    ...
                    void setDrawColor(const Color& rgb, float alpha);
                    ...
                    void drawRect(ARK::Core::Geometry::RectangleTemplate<int>* rect) const;
                    void drawRect(ARK::Core::Geometry::RectangleTemplate<float>* rect) const;
                    ...
                    void drawCircle(ARK::Core::Geometry::Circle<int>* circle);
                    void drawCircle(ARK::Core::Geometry::Circle<float>* circle);
