...
#ifndef ARK_CORE_GRAPHICS_SHADERS_HSVSHADER_H_
#define ARK_CORE_GRAPHICS_SHADERS_HSVSHADER_H_
...
namespace ARK {
    namespace Core {
        namespace Graphics {
            ...
            class ARK2D_API HSVGeometryShader : public ARK::Core::Graphics::Shader
            { 
                public:
            ...
            class ARK2D_API HSVTextureShader : public ARK::Core::Graphics::Shader
            { 
                public:
                    unsigned int _ModelMatrix;
                    unsigned int _ViewMatrix;
