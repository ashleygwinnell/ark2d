...
namespace ARK {
    namespace Core {
        namespace State {
            ...
            void StateBasedGame::enterState(unsigned int id, ARK::Core::State::Transition::Transition* leave, ARK::Core::State::Transition::Transition* enter) {
            ...
            void StateBasedGame::enterState(GameState* state, ARK::Core::State::Transition::Transition* leave, ARK::Core::State::Transition::Transition* enter) {
            ...
            void StateBasedGame::gamepadConnected(ARK::Core::Controls::Gamepad* gamepad) {
            ...
            void StateBasedGame::gamepadDisconnected(ARK::Core::Controls::Gamepad* gamepad) {
            ...
            void StateBasedGame::buttonPressed(ARK::Core::Controls::Gamepad* gamepad, unsigned int button) {
            ...
            void StateBasedGame::buttonReleased(ARK::Core::Controls::Gamepad* gamepad, unsigned int button) {
            ...
            void StateBasedGame::axisMoved(ARK::Core::Controls::Gamepad* gamepad, unsigned int axis, float value) {
