...
#ifndef ARK_CORE_GEOMETRY_SHAPE_H_
#define ARK_CORE_GEOMETRY_SHAPE_H_
	...
	namespace Core {
		namespace Geometry {
			...
			class Shape {
                ...
                static bool collision_cubeRectangle(ARK::Core::Geometry::CubeTemplate<T>* c, ARK::Core::Geometry::RectangleTemplate<T>* r)
					{
