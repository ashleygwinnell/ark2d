    ...
    namespace Core {
        namespace Geometry {
            ...
            void AdvancedPolygon::updateLines() {
                ...
                for (unsigned int i = 0; i < holes.size(); i++)
                {
                    ...
                    for (unsigned int j = 0; j < poly->size(); j++) {
                        ...
                        ARK::Core::Geometry::Line<float> line(start->getX(), start->getY(), end->getX(), end->getY());
            ...
            void AdvancedPolygon::render() {
                ...
                for (unsigned int i = 0; i < holes.size(); i++)
                {
                    ARK::Core::Geometry::Polygon<float>* sp = &holes[i];
                    renderInner(sp, true);
                }

                for (unsigned int i = 0; i < outers.size(); i++)
                {
                    ARK::Core::Geometry::Polygon<float>* sp = &outers[i];
                    renderInner(sp, false);
                }

            }
            void AdvancedPolygon::renderInner(ARK::Core::Geometry::Polygon<float>* sp, bool hole)
            {
                ...
                for (unsigned int j = 0; j < sp->getPoints()->size(); j++)
                {
                    ...
                    ARK::Core::Geometry::Vector2<float>* point = sp->getPoint(j);
                    ...
                    ARK::Core::Geometry::Vector2<float>* spnext = NULL;
