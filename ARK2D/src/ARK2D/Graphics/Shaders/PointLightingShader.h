...
#ifndef ARK_GRAPHICS_POINTLIGHTINGSHADER3D_H_
#define ARK_GRAPHICS_POINTLIGHTINGSHADER3D_H_
...
namespace ARK { 
	namespace Graphics { 
		...
		class ARK2D_API PointLightingGeometryShader : public ARK::Graphics::Shader 
		{ 
			public:
		...
		class ARK2D_API PointLightingTextureShader : public ARK::Graphics::Shader 
		{ 
			public:
				PointLightingShader* container; 
				unsigned int _LightColor;
