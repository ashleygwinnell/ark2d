...
#ifndef ARK_GRAPHICS_SHADERS_DIRECTIONALLIGHTINGSHADER_H_
#define ARK_GRAPHICS_SHADERS_DIRECTIONALLIGHTINGSHADER_H_
...
namespace ARK { 
	namespace Graphics { 
		...
		class ARK2D_API DirectionalLightingGeometryShader : public ARK::Graphics::Shader 
		{ 
			public:
		...
		class ARK2D_API DirectionalLightingTextureShader : public ARK::Graphics::Shader 
		{ 
			public:
				DirectionalLightingShader* container;
...
#endif /* ARK_GRAPHICS_DIRECTIONALLIGHTINGSHADER_H_ */
