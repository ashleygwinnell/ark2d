...
class ARK2DBuildSystem:
	...
	def dllInit(self):
		self.mkdirs.expand([
			...
			self.build_folder + "\\src\\ARK2D\\libJSON",
			self.build_folder + "\\src\\ARK2D\\lpng151",
			self.build_folder + "\\src\\ARK2D\\ogg",
			self.build_folder + "\\src\\ARK2D\\particles",
			self.build_folder + "\\src\\ARK2D\\tinyxml",
			self.build_folder + "\\src\\ARK2D\\vorbis",
			self.build_folder + "\\src\\ARK2D\\zlib123",
		...
		self.src_files.extend([
			...
			'src\\ARK2D\\UIButton.cpp',
			'src\\ARK2D\\UISimpleButton.cpp',
			'src\\ARK2D\\ARK2D_Path\\PathLoader.cpp',
			...
			'src\\ARK2D\\libJSON\\JSON_Worker.cpp',
			'src\\ARK2D\\libJSON\\jsonmain.cpp',
			'src\\ARK2D\\libJSON\\JSONNode.cpp',
			'src\\ARK2D\\lpng151\\png.c',
			'src\\ARK2D\\lpng151\\pngerror.c',
			'src\\ARK2D\\lpng151\\pngget.c',
			'src\\ARK2D\\lpng151\\pngmem.c',
			'src\\ARK2D\\lpng151\\pngpread.c',
			'src\\ARK2D\\lpng151\\pngread.c',
			'src\\ARK2D\\lpng151\\pngrio.c',
			'src\\ARK2D\\lpng151\\pngrtran.c',
			'src\\ARK2D\\lpng151\\pngrutil.c',
			'src\\ARK2D\\lpng151\\pngset.c',
			'src\\ARK2D\\lpng151\\pngtrans.c',
			'src\\ARK2D\\lpng151\\pngwio.c',
			'src\\ARK2D\\lpng151\\pngwrite.c',
			'src\\ARK2D\\lpng151\\pngwtran.c',
			'src\\ARK2D\\lpng151\\pngwutil.c',
			...
			'src\\ARK2D\\tinyxml\\tinystr.cpp',
			'src\\ARK2D\\tinyxml\\tinyxml.cpp',
			'src\\ARK2D\\tinyxml\\tinyxmlerror.cpp',
			'src\\ARK2D\\tinyxml\\tinyxmlparser.cpp',
